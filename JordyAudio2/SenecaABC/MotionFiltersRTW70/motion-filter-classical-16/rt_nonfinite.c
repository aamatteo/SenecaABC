 ...
 */
void __attribute__((weak)) rt_InitInfAndNaN(size_t realSize)
{
 ...
 */
boolean_T __attribute__((weak)) rtIsInf(real_T value)
{
 ...
 */
boolean_T __attribute__((weak)) rtIsInfF(real32_T value)
{
 ...
 */
boolean_T __attribute__((weak)) rtIsNaN(real_T value)
{
 ...
 */
boolean_T __attribute__((weak)) rtIsNaNF(real32_T value)
{
  return((value!=value) ? 1U : 0U);
}
