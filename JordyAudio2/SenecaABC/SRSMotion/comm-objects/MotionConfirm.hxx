...
#ifndef MotionConfirm_hxx
#define MotionConfirm_hxx
...
#if GENCODEGEN != 110
#error "Generated MotionConfirm.hxx too old, please clean with 'make mrproper'"
#endif
...
/**reply to MotionRequest
   FROM MotionLimiter
   TO ... (motion test modules)
    */
struct MotionConfirm
{
  /** typedef for internal reference */
  typedef MotionConfirm __ThisDCOType__;
...
public:
  ...
  /** copy constructor. */
  MotionConfirm(const MotionConfirm& o);

#if !defined(__DCO_NOPACK)
  /** constructor to restore an MotionConfirm from amorphous storage. */
  MotionConfirm(dueca::AmorphReStore& r);
#endif
  ...
  inline static void* operator new(size_t size, MotionConfirm*& o)
  { return reinterpret_cast<void*>(o); }
#endif

#if !defined(__DCO_NOPACK)
  /** packs the MotionConfirm into amorphous storage. */
  void packData(::dueca::AmorphStore& s) const;

  /** packs the MotionConfirm into amorphous storage.
      only differences with a previous object are packed. */
  void packDataDiff(::dueca::AmorphStore& s, const MotionConfirm& ref) const;

  /** unpacks the MotionConfirm from an amorphous storage. */
  void unPackData(::dueca::AmorphReStore& s);

  /** unpacks the differences for MotionConfirm
      from an amorphous storage. */
  void unPackDataDiff(::dueca::AmorphReStore& s);
#endif

  /** Test for equality. */
  bool operator == (const MotionConfirm& o) const;

  /** Test for inequality. */
  inline bool operator != (const MotionConfirm& o) const
  { return !(*this == o); }

  /** Assignment operator. */
  MotionConfirm& operator=(const MotionConfirm& o);

  /** prints the MotionConfirm to a stream. */
...
PRINT_NS_START;
inline std::ostream&
operator << (std::ostream& s, const MotionConfirm::motion_position& o)
{ return s << getString(o); }
inline std::istream&
operator >> (std::istream& s, MotionConfirm::motion_position& o)
...
/** print to a stream. */
inline std::ostream &
operator << (std::ostream& s, const MotionConfirm& o)
{ return o.print(s); }
};
...
/** Template specialization, defines a trait that is needed if
    MotionConfirm is ever used inside other dco objects. */
template <>
struct dco_nested<MotionConfirm> : public dco_isnested { };
template <>
struct dco_nested< MotionConfirm::motion_position > : public dco_isenum { };
};
#endif
