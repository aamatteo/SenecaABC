...
/** A module.
    ...
    \verbinclude l-glights.scm
*/
class LGlights: public SimulationModule
{
  /** self-define the module type, to ease writing the parameter table */
  typedef LGlights _ThisModule_;
...
public: // construction and further specification
  ...
  LGlights(Entity* e, const char* part, const PrioritySpec& ts);
