...
static ::dueca::CommObjectMemberAccess
  <ControlEvent,int >
  ControlEvent_member_display_lg_failure(&ControlEvent::display_lg_failure, "display_lg_failure");
static ::dueca::CommObjectMemberAccess
  <ControlEvent,float >
...
static const ::dueca::CommObjectDataTable entriestable[] = {
  ...
  { &ControlEvent_member_display_lg_failure },
...
const uint32_t ControlEvent::magic_check_number=0x4beaa0f6;
...
ControlEvent::ControlEvent(const ControlEvent& other):
    ...
    display_lg_failure(other.display_lg_failure),
    ARI(other.ARI),
...
void ControlEvent::packDataDiff(::dueca::AmorphStore& s, const ControlEvent& ref) const
{
  ...
  ::dueca::checkandpackdiffsingle(this->rudder_bias, ref.rudder_bias,
                         s, im);
  ::dueca::checkandpackdiffsingle(this->display_lg_failure, ref.display_lg_failure,
                         s, im);
...
void ControlEvent::unPackData(::dueca::AmorphReStore& s)
{
  ...
  ::unPackData(s, this->display_lg_failure);
...
void ControlEvent::unPackDataDiff(dueca::AmorphReStore& s)
{
  ...
  ::dueca::checkandunpackdiffsingle(this->display_lg_failure, s, im);
...
bool ControlEvent::operator == (const ControlEvent& other) const
{
  ...
  if (this->display_lg_failure != other.display_lg_failure) return false;
...
ControlEvent::operator=(const ControlEvent& other)
{
  ...
  this->display_lg_failure = other.display_lg_failure;
  this->ARI = other.ARI;
...
void ControlEvent::packData(::dueca::AmorphStore& s) const
{
  ...
  ::packData(s, this->display_lg_failure);
  ::packData(s, this->ARI);
...
std::ostream & ControlEvent::print(std::ostream& s) const
{
  s << "ControlEvent("
    ...
    << "display_lg_failure=" << this->display_lg_failure << ','
    << "ARI=" << this->ARI << ','
