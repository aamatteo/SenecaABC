...
#ifndef WeatherProxy_hxx
#define WeatherProxy_hxx
...
/** A module.
    ...
    \verbinclude weather-proxy.scm
*/
class WeatherProxy: public SimulationModule
{
  /** self-define the module type, to ease writing the parameter table */
  typedef WeatherProxy _ThisModule_;

private: // simulation data
  // declare the data you need in your simulation
  FGWeatherInput myFGW;
...
private: // channel access
  ...
  EventChannelReadToken<WindEvent> r_token;
  EventChannelWriteToken<FGWeatherInput> w_token;
...
public: // construction and further specification
  ...
  WeatherProxy(Entity* e, const char* part, const PrioritySpec& ts);
