...
#ifndef STARSelect_hxx
#define STARSelect_hxx
...
#if GENCODEGEN != 110
#error "Generated STARSelect.hxx too old, please clean with 'make mrproper'"
#endif
...
struct STARSelect
{
  ...
  typedef STARSelect __ThisDCOType__;
...
public:
  ...
  /** copy constructor. */
  STARSelect(const STARSelect& o);

#if !defined(__DCO_NOPACK)
  /** constructor to restore an STARSelect from amorphous storage. */
  STARSelect(dueca::AmorphReStore& r);
#endif
  ...
  inline static void* operator new(size_t size, STARSelect*& o)
  { return reinterpret_cast<void*>(o); }
#endif

#if !defined(__DCO_NOPACK)
  /** packs the STARSelect into amorphous storage. */
  void packData(::dueca::AmorphStore& s) const;

  /** packs the STARSelect into amorphous storage.
      only differences with a previous object are packed. */
  void packDataDiff(::dueca::AmorphStore& s, const STARSelect& ref) const;

  /** unpacks the STARSelect from an amorphous storage. */
  void unPackData(::dueca::AmorphReStore& s);

  /** unpacks the differences for STARSelect
      from an amorphous storage. */
  void unPackDataDiff(::dueca::AmorphReStore& s);
#endif

  /** Test for equality. */
  bool operator == (const STARSelect& o) const;

  /** Test for inequality. */
  inline bool operator != (const STARSelect& o) const
  { return !(*this == o); }

  /** Assignment operator. */
  STARSelect& operator=(const STARSelect& o);

  /** prints the STARSelect to a stream. */
...
/** print to a stream. */
inline std::ostream &
operator << (std::ostream& s, const STARSelect& o)
{ return o.print(s); }
};
...
/** Template specialization, defines a trait that is needed if
    STARSelect is ever used inside other dco objects. */
template <>
struct dco_nested<STARSelect> : public dco_isnested { };
};
#endif
